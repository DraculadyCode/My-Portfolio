...
function handleResolutionRedirect() {
  ...
  if (window.innerWidth <= 1150) {
    // Redirect to mobile versions on a smaller screen
    ...
    // Redirect back to desktop versions on a larger screen
    if (currentUrl.includes("resumeMobile-english.html")) {
      window.location.href = "../Pages/resume-english.html";
    } else if (currentUrl.includes("resumeMobile-german.html")) {
      window.location.href = "../Pages/resume-german.html";
    } else if (currentUrl.includes("resumeMobile-english.html")) {
